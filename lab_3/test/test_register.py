...
class RegisterTest(unittest.TestCase):
    ...
    def test_should_succeed_when_user_can_navigate_to_register_form(self):
    ...
    def test_should_fail_when_last_name_empty(self):
        self.registration_page.open()
    ...
    def test_should_succeed_when_middle_name_empty(self):
        self.registration_page.open()
    ...
    def test_should_fail_when_invalid_email_format(self):
        self.registration_page.open()
    ...
    def test_should_fail_when_invalid_email_hostname(self):
        self.registration_page.open()
    ...
    def test_should_fail_when_confirmation_empty(self):
        self.registration_page.open()
    ...
    def test_should_fail_when_password_and_confirmation_mismatch(self):
        self.registration_page.open()
    ...
    def test_should_fail_when_password_shorter_than_six_symbols(self):
        self.registration_page.open()
    ...
    def test_should_succeed_when_inputs_correct_and_user_not_exists(self):
        self.registration_page.open()
        self.registration_page.fill_form(self.profile)
    ...
    def test_should_fail_when_inputs_correct_but_user_already_exists(self):
        self.registration_page.open()
        self.registration_page.fill_form(self.profile)
