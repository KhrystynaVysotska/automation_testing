...
class RegistrationPage(BasePage):
    ...
    def search_failed_registration_message(self):
        return self.browser.find_element(*self.FAILED_REGISTRATION_MSG).text

    def search_failed_registration_messages(self):
        messages = self.browser.find_elements(*self.FAILED_REGISTRATION_MSG)
        return list(map(lambda msg: msg.text, messages))

    def search_sucessful_registration_message(self):
        return self.browser.find_element(*self.SUCCESSFUL_REGISTRATION_MSG).text
